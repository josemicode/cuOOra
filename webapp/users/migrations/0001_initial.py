    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField()),
                ('apto', models.BooleanField(default=None, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('specific_subclass', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='votes', to='contenttypes.contenttype')),
